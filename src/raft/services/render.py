...
class StackRenderer:
    ...
    def generated_root(self) -> Path:
        return self.stack.root / GENERATED_DIR
    ...
    def _compose_apps_yaml(self, contracts: dict[str, ServiceContract]) -> str:
        if not self.stack.apps:
            return (
                "# Generated by `uv run raft render` — do not edit.\n"
                "# Source: state/apps/*.yaml (applied App manifests)\n"
                "services: {}\n"
            )
        ...
        for app in self.stack.apps:
            ...
            if app.source == "docker":
                ...
                try:
                    ...
                    raise ValueError(
                        f"{app.name}: build context {ctx} is outside orchestrator root"
                    ) from exc
